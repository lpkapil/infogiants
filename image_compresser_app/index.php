...
<head>
    ...
    <title>InfoGiants Tools- Image Compression Tool</title>
...
<header>
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a href="https://infogiants.com/" class="navbar-brand d-flex align-items-center">
            ...
            <span class="ms-2 fs-4 text-white">InfoGiants Tools</span><span class="fs-6 text-white ms-3 mt-1"> - Free softwares and information</span>
        </a>
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Image Compressor</h2>
        ...
        <div class="col-md-6">
            <form action="process.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <div class="form-text">Only JPG and PNG images are allowed. Maximum size: 5MB.</div>
                </div>
